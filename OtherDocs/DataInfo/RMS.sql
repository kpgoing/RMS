...
-- -----------------------------------------------------
-- Table `RMS`.`CheckStatusOfTeacher`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `RMS`.`CheckStatusOfTeacher` (
  `idCheckStatusOfTeacher` INT NOT NULL AUTO_INCREMENT,
  `idTeacher` INT NOT NULL,
  `checkStatus` TINYINT(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`idCheckStatusOfTeacher`),
  INDEX `fk_CheckStatusOfTeacher_Teacher1_idx` (`idTeacher` ASC),
  CONSTRAINT `fk_CheckStatusOfTeacher_Teacher1`
    FOREIGN KEY (`idTeacher`)
    REFERENCES `RMS`.`Teacher` (`idTeacher`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
